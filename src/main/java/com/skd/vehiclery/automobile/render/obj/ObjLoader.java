package com.skd.vehiclery.automobile.render.obj;
...
public class ObjLoader implements ResourceManagerReloadListener {
    ...
    public static final Identifier ID = Vehiclery.rl("obj_loader");

    public static final Logger LOG = LogManager.getLogger("Vehiclery | OBJ Loader");
