...
public record AutomobileEngine(
    ...
    public static final Identifier ID = Vehiclery.rl("engine");

    public static final ResourceKey<Registry<AutomobileEngine>> REGISTRY = ResourceKey.createRegistryKey(Vehiclery.rl("automobile_engine"));
    ...
    public static final AutomobileEngine EMPTY = new AutomobileEngine(true, 0.01f, 0.01f,
            ...
            model(Identifier.parse("empty"), Vehiclery.rl("empty"))
    );

    public static final ResourceKey<AutomobileEngine> EMPTY_KEY = BOOTSTRAP.register(Vehiclery.rl("empty"), EMPTY);
    ...
    public static final ResourceKey<AutomobileEngine> STONE = BOOTSTRAP.register(Vehiclery.rl("stone"), of(
            0.3f, 0.58f,
            VehiclerySounds.STONE_ENGINE::require,
            model(
                    Vehiclery.rl("textures/entity/automobile/engine/stone.png"), Vehiclery.rl("engine/stone"),
                    new AutomobileEngine.ExhaustPos(0, 7f, -8.3f, 50, 0)
            )
    ));

    public static final ResourceKey<AutomobileEngine> IRON = BOOTSTRAP.register(Vehiclery.rl("iron"), of(
            0.5f, 0.75f,
            VehiclerySounds.IRON_ENGINE::require,
            model(
                    Vehiclery.rl("textures/entity/automobile/engine/iron.png"), Vehiclery.rl("engine/iron"),
                    new AutomobileEngine.ExhaustPos(-3.5f, 5.4f, -8, 26, 0),
                    new AutomobileEngine.ExhaustPos(3.5f, 5.4f, -8, 26, 0)
            )
    ));

    public static final ResourceKey<AutomobileEngine> COPPER = BOOTSTRAP.register(Vehiclery.rl("copper"), of(
            0.375f, 0.68f,
            VehiclerySounds.COPPER_ENGINE::require,
            model(
                    Vehiclery.rl("textures/entity/automobile/engine/copper.png"), Vehiclery.rl("engine/copper"),
                    new AutomobileEngine.ExhaustPos(2, 1.625f, -8.95f, 26, 0)
            )
    ));

    public static final ResourceKey<AutomobileEngine> GOLD = BOOTSTRAP.register(Vehiclery.rl("gold"), of(
            0.8f, 0.75f,
            VehiclerySounds.GOLD_ENGINE::require,
            model(
                    Vehiclery.rl("textures/entity/automobile/engine/gold.png"), Vehiclery.rl("engine/gold"),
                    new AutomobileEngine.ExhaustPos(4, 9.3f, -7.75f, 26, 0),
                    new AutomobileEngine.ExhaustPos(-4, 9.3f, -7.75f, 26, 0)
            )
    ));

    public static final ResourceKey<AutomobileEngine> DIAMOND = BOOTSTRAP.register(Vehiclery.rl("diamond"), of(
            0.95f, 0.85f,
            VehiclerySounds.DIAMOND_ENGINE::require,
            model(
                    Vehiclery.rl("textures/entity/automobile/engine/diamond.png"), Vehiclery.rl("engine/diamond"),
    ...
    public static final ResourceKey<AutomobileEngine> CREATIVE = BOOTSTRAP.register(Vehiclery.rl("creative"), of(
            1f, 1f,
            VehiclerySounds.CREATIVE_ENGINE::require,
            model(
                    Vehiclery.rl("textures/entity/automobile/engine/creative.png"), Vehiclery.rl("engine/creative"),
