...
import com.skd.vehiclery.automobile.attachment.rear.BackhoeRearAttachment;
...
import com.skd.vehiclery.automobile.attachment.rear.EmptyRearAttachment;
import com.skd.vehiclery.automobile.attachment.rear.PassengerSeatRearAttachment;
import com.skd.vehiclery.automobile.attachment.rear.PaverRearAttachment;
...
public record RearAttachmentType<T extends RearAttachment>(
    ...
    public static final Identifier ID = Vehiclery.rl("rear_attachment");
    ...
    public static final RearAttachmentType<EmptyRearAttachment> EMPTY = register(new RearAttachmentType<>(
            Vehiclery.rl("empty"), EmptyRearAttachment::new, new RearAttachmentModel(Identifier.parse("empty"), Vehiclery.rl("empty"), 0)
    ));

    public static final RearAttachmentType<PassengerSeatRearAttachment> PASSENGER_SEAT = register(new RearAttachmentType<>(
            Vehiclery.rl("passenger_seat"), PassengerSeatRearAttachment::new,
            new RearAttachmentModel(Vehiclery.rl("textures/entity/automobile/rear_attachment/passenger_seat.png"), Vehiclery.rl("rear_attachment/passenger_seat"), 11)
    ));
    ...
    public static final RearAttachmentType<BlockRearAttachment> GRINDSTONE = register(block("grindstone", Vehiclery.rl("rear_attachment/grindstone"), BlockRearAttachment::grindstone));
    public static final RearAttachmentType<BlockRearAttachment> STONECUTTER = register(block("stonecutter", Vehiclery.rl("rear_attachment/stonecutter"), BlockRearAttachment::stonecutter));
    ...
    public static final RearAttachmentType<BannerPostRearAttachment> BANNER_POST = register(new RearAttachmentType<>(
            Vehiclery.rl("banner_post"), BannerPostRearAttachment::new,
            new RearAttachmentModel(Vehiclery.rl("textures/entity/automobile/rear_attachment/banner_post.png"), Vehiclery.rl("rear_attachment/banner_post"), 10)
    ));

    public static final RearAttachmentType<BackhoeRearAttachment> BACKHOE = register(new RearAttachmentType<>(
            Vehiclery.rl("backhoe"), BackhoeRearAttachment::new,
            new RearAttachmentModel(Vehiclery.rl("textures/entity/automobile/rear_attachment/backhoe.png"), Vehiclery.rl("rear_attachment/plow"), 11)
    ));

    public static final RearAttachmentType<PaverRearAttachment> PAVER = register(new RearAttachmentType<>(
            Vehiclery.rl("paver"), PaverRearAttachment::new,
            new RearAttachmentModel(Vehiclery.rl("textures/entity/automobile/rear_attachment/paver.png"), Vehiclery.rl("rear_attachment/plow"), 11)
    ));
    ...
    private static RearAttachmentType<BlockRearAttachment> chest(String name, BiFunction<RearAttachmentType<BlockRearAttachment>, AutomobileEntity, BlockRearAttachment> constructor) {
        return block(name, Vehiclery.rl("rear_attachment/chest"), constructor);
    }
    ...
    private static RearAttachmentType<BlockRearAttachment> block(String name, BiFunction<RearAttachmentType<BlockRearAttachment>, AutomobileEntity, BlockRearAttachment> constructor) {
        return block(name, Vehiclery.rl("rear_attachment/block"), constructor);
    }
    ...
    private static RearAttachmentType<BlockRearAttachment> block(String name, Identifier model, BiFunction<RearAttachmentType<BlockRearAttachment>, AutomobileEntity, BlockRearAttachment> constructor) {
        return new RearAttachmentType<>(
                Vehiclery.rl(name), constructor,
                new RearAttachmentModel(Vehiclery.rl("textures/entity/automobile/rear_attachment/"+name+".png"), model, 11)
        );
    }
